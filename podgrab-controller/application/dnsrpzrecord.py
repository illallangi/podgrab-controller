...
CONTROLLER="application-dnsrpzrecord"
...
async def application_dnsrpzrecord_idx(
    namespace,
    body,
    **_,
):
...
@kopf.on.probe(
    id=application_dnsrpzrecord_idx.__name__,
)
async def application_dnsrpzrecord_probe(
    application_dnsrpzrecord_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o
            for o in application_dnsrpzrecord_idx[namespace]
        }
        for namespace in application_dnsrpzrecord_idx
    }
...
async def application_dnsrpzrecord(
    namespace,
    body,
    patch,
    **kwargs,
